...
class PresentationTest {
    ...
    fun `play and stop music assign currentBgm without blocking`() {
        ...
        engine.triggerEvent()
        assertEquals("tension", engine.currentBgm)
        ...
        assertEquals("pueblo", engine2.currentBgm)
        engine2.triggerEvent()
        assertNull(engine2.currentBgm)
    ...
    fun `map imposes bgm and weather on load and transfer`() {
        ...
        assertEquals("campo", engine.currentBgm)
        ...
        assertEquals("mazmorra", engine.currentBgm)
